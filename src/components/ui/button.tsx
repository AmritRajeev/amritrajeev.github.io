...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-accent shadow-card",
        destructive:
        ...
        gradient: "gradient-accent text-white hover:opacity-90 shadow-card font-semibold",
        professional: "bg-primary text-primary-foreground hover:bg-primary-accent shadow-card border border-primary/20",
        minimal: "text-primary hover:bg-primary-light transition-smooth",
      },
      size: {
